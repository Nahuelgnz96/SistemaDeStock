  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto me-auto mb-2 mb-lg-0 nav-underline">
        <li class="nav-item">
          <a class="nav-link" href="v_agregar_marcas.php">Agregar</a>
        </li>
        <li class="nav-item">
...
<h1 class="text-center mt-3 mb-5">Lista de Marcas</h1>
<div class="container">
<button class="btn btn-primary" id="seleccionarTodos" >Seleccionar Todos</button>
<form id="eliminarCategoriasForm" method="post" >

    <table class="table text-center p-5 mb-5">
        <thead>
            <tr>
        ...
        <tbody>
            <?php include "../controllers/c_lista_marcas.php"?>
        </tbody>
    </table>
...
<script src="../js/eliminarMar.js?v=1.0"></script>
<script src="
